<?php
// test_pagos.php - Archivo de prueba para verificar el sistema de pagos
...
try {
    ...
    try {
        ...
        // Verificar allowedFields en PagoModel
        echo "<h3>Campos permitidos en PagoModel:</h3>";
        echo "<pre>" . print_r($pagoModel->getAllowedFields(), true) . "</pre>";
