...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-09-2025 a las 15:10:18
...
(1, 'Super Administrador', 'superadmin@educa.edu', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Superadmin', 'activo', '2025-09-23 06:32:55', '2025-09-23 06:32:55');
...
ALTER TABLE `deudas`
  ...
  ADD KEY `idx_deudas_estado` (`estado`),
  ADD KEY `idx_deudas_vencimiento` (`fecha_vencimiento`);
