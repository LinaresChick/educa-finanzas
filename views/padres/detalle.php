...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            <a href="<?php echo BASE_URL; ?>padres/editar/<?php echo $padre['id_padre']; ?>" class="btn btn-warning">
        ...
        <div class="col-lg-8">
            <div class="card shadow">
                <div class="card-header py-3 d-flex justify-content-between align-items-center">
                    ...
                    <a href="<?php echo BASE_URL; ?>padres/asociarEstudiante/<?php echo $padre['id_padre']; ?>" class="btn btn-sm btn-primary">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group">
                                                    <a href="<?php echo BASE_URL; ?>estudiantes/detalle/<?php echo $estudiante['id_estudiante']; ?>" class="btn btn-sm btn-info" title="Ver detalles">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="<?php echo BASE_URL; ?>padres/desasociarEstudiante" method="post">
