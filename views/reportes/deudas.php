...
<?php if (!isset($_SESSION['usuario']) || !in_array($_SESSION['usuario']['rol'], ['Superadmin', 'Administrador', 'Colaborador'])) { header("Location: index.php?controller=Auth&action=acceso_denegado"); exit; } ?>
