                        ...
                        <div class="row mt-3">
                            <div class="col-md-12">
                                <div class="alert alert-info">
                                    ...
                                    <p><strong>Fecha de creación:</strong> <?= date('d/m/Y H:i', strtotime($usuario['creado'])) ?></p>
                                    <p><strong>Última actualización:</strong> <?= date('d/m/Y H:i', strtotime($usuario['actualizado'])) ?></p>
