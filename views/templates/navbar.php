...
<div id="sidebar" class="sidebar">
  ...
  <ul class="sidebar-menu">
    ...
    <?php if (isset($_SESSION['usuario']) && in_array($_SESSION['usuario']['rol'], ['Superadmin', 'Administrador', 'Colaborador'])): ?>
    <li class="sidebar-item">
    ...
    <?php if (isset($_SESSION['usuario']) && in_array($_SESSION['usuario']['rol'], ['Superadmin', 'Administrador'])): ?>
